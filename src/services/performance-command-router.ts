...
const local = new Set(['performance.endpoint','engine.clock.probe','waveform.ensure','waveform.manifest','engine.ping','state.snapshot','audio.devices.list','audio.config.get','meters.subscribe','mixer.channel.pfl','mixer.headphone.gain','mixer.headphone.mix','sampler.state','sampler.pfl','recording.directory.set','recording.format.set']);
