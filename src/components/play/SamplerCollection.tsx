...
import { usePlayActionDrop } from "./PlayDragDrop";
...
export function SamplerCollection() {
  ...
  const trackDrop = usePlayActionDrop("play-sampler-panel", dropTrack);
  return <section ref={trackDrop.setNodeRef} data-sampler-collection data-native-drop-active={trackDrop.isOver ? "true" : undefined} className="sampler-collection">
