...
uvicorn main:app --host 127.0.0.1 --port $PLUMDECK_PORT --reload --reload-exclude "*.duckdb" --reload-exclude "*.duckdb.wal" --reload-exclude "*.log" 2>&1 | grep --line-buffered -v "No network created"
